...
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS simple_code VARCHAR(100);
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS goods_level VARCHAR(50);
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS tax_rate VARCHAR(20);
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS goods_manager VARCHAR(100);
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS can_sale BOOLEAN DEFAULT TRUE;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS can_purchase BOOLEAN DEFAULT TRUE;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS is_weighted BOOLEAN DEFAULT FALSE;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS is_presale BOOLEAN DEFAULT FALSE;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS origin VARCHAR(100);
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS warning_days INT DEFAULT 0;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS min_order_qty DECIMAL(18,3) DEFAULT 0;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS pallet_qty INT DEFAULT 0;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS stack_layers INT DEFAULT 0;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS base_weight DECIMAL(18,3) DEFAULT 0;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS base_volume DECIMAL(18,6) DEFAULT 0;
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS goods_intro VARCHAR(1000);
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS remark VARCHAR(500);
ALTER TABLE base_goods ADD COLUMN IF NOT EXISTS unit_config VARCHAR(4000);
