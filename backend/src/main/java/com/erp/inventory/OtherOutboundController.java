...
public class OtherOutboundController {
    ...
    public ApiResponse<Map<String, Object>> audit(@Valid @RequestBody AuditRequest request) {
        ...
        dayCloseGuard.assertWritable(LocalDate.now(), "其他出库单", outboundNo);
        ...
        jdbcTemplate.update("""
                UPDATE inv_other_outbound SET status='APPROVED', bill_date=CURRENT_DATE, cost_amount=?,
    ...
    public ApiResponse<Map<String, Object>> reverseAudit(@Valid @RequestBody AuditRequest request) {
        ...
        dayCloseGuard.assertBillWritable("inv_other_outbound", "bill_date", "outbound_id", outboundId, "其他出库单");
    ...
    private void log(String moduleCode, String action, String bizNo, String detail) {
        ...
        opLog.log(moduleCode, action, com.erp.system.KeyFields.BIZ_OTHER_OUTBOUND, null, bizNo, detail);
    }
