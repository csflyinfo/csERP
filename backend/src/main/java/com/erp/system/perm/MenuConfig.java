...
public class MenuConfig {
    ...
    private MenuNode financeMenus() {
        MenuNode fin = MenuNode.rootDir("finance", "财务管理", "Money", "ERP")
                ...
                .page("fin.factory_settle", "厂家费用兑现单", "/finance/factory-settle")
    ...
    private MenuNode reportMenus() {
        ...
        MenuNode node = MenuNode.rootDir("report", "报表中心", "TrendCharts", "ERP")
                ...
                // 报表中心三期：库存分析 2 表 + 综合分析 + 库管/司机绩效 + 财务 5 表
                .page("report.shortage_analysis", "缺货商品分析", "/report/shortage-analysis")
                .page("report.goods_turnover", "商品周转率分析", "/report/goods-turnover")
                .page("report.goods_analysis", "商品综合分析", "/report/goods-analysis")
                .page("report.wms_keeper_perf", "库管员绩效报表", "/report/wms-keeper-perf")
                .page("report.driver_delivery_perf", "司机配送绩效报表", "/report/driver-delivery-perf")
                .page("report.ar_aging", "应收账款账龄分析表", "/report/ar-aging")
                .page("report.ap_aging", "应付账款账龄分析表", "/report/ap-aging")
                .page("report.customer_ar_summary", "客户应收汇总表", "/report/customer-ar-summary")
                .page("report.supplier_ap_summary", "供应商应付汇总表", "/report/supplier-ap-summary")
                .page("report.fund_journal", "现金日记账", "/report/fund-journal")
