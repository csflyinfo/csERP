...
public class BaseMasterController {
    ...
    private static final Map<String, MasterSpec> SPECS = Map.ofEntries(
        ...
        Map.entry("expenseType", new MasterSpec("base_expense_type", "expense_type_id", "expense_type_code",
                List.of("expense_type_id", "expense_type_code", "expense_type_name", "parent_code", "direction", "cost_participation", "remark", "status", "gl_expense_account_code"),
                List.of("expense_type_name", "parent_code", "direction", "cost_participation", "remark", "status", "gl_expense_account_code"))),
    ...
    Map.entry("counterpartyType", new MasterSpec("base_counterparty_type", "type_id", "type_code",
        ...
        Map.entry("fundAccount", new MasterSpec("base_fund_account", "fund_account_id", "fund_account_code",
                List.of("fund_account_id", "fund_account_code", "fund_account_name", "parent_code", "account_type", "balance", "remark", "is_system", "status", "gl_account_code"),
                List.of("fund_account_name", "parent_code", "account_type", "balance", "remark", "status", "gl_account_code"))),
