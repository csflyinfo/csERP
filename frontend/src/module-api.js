export const moduleApis = {
  ...
  purchaseInvoice: { page: '/purchase/invoice/page', save: '/purchase/invoice/create', update: '/purchase/invoice/update', detail: '/purchase/invoice/detail', audit: '/purchase/invoice/audit', reverseAudit: '/purchase/invoice/reverse-audit', void: '/purchase/invoice/void', delete: '/purchase/invoice/delete', certify: '/purchase/invoice/certify', updateRemark: '/purchase/invoice/update-remark', availableLines: '/purchase/invoice/available-lines' },
  ...
  // 采购发票来票报表（PRD-30）
  invoiceTrackReport: { page: '/purchase/invoice/report/track/page' },
  invoiceTrackGoodsReport: { page: '/purchase/invoice/report/track/page' },
  invoiceSupplierReport: { page: '/purchase/invoice/report/supplier/page' },
  invoiceUnmatchedReport: { page: '/purchase/invoice/report/unmatched/page' },
  invoiceDiffReport: { page: '/purchase/invoice/report/unmatched/page' },
}
...
const EXACT_TITLE_MAP = {
  ...
  '采购发票单号': ['invoiceNo'],
  '发票号码': ['invoiceNumber', 'invoiceNo'],
  '发票代码': ['invoiceCode'],
  '发票类型': ['invoiceType'],
  '红蓝标志': ['direction'],
  '本次勾稽金额': ['thisAmount'],
  '勾稽前已来票': ['matchedBefore'],
  '差异原因': ['diffReason'],
  '来票状态': ['invoiceStatus'],
  '未票金额': ['unbilledAmount'],
  '来票率': ['invoiceRate'],
  '关联发票': ['invoiceNos'],
  '账龄天数': ['agingDays'],
  '收货金额': ['recvAmount', 'goodsAmount'],
  '来票金额': ['invoicedAmount', 'invoiceAmount'],
  '发票份数': ['invoiceCount'],
  '进项税额': ['taxAmount'],
  '已认证税额': ['certifiedTax'],
  '未认证份数': ['uncertifiedCount'],
  '收货数量': ['recvQty', 'qty'],
  '来票数量': ['invQty'],
  '费用单号': ['expenseNo'],
  '调拨单号': ['transferNo'],
