...
export const IMPORT_PRESETS = {
  ...
  initAp: {
    ...
    templateHeaders: ['供应商编码', '供应商名称', '原单据号', '原单据日期', '应付金额', '期初预付金额', '备注'],
    fieldMap: {
  ...
  initApPrepay: {
    title: '供应商期初预付补录导入',
    templateName: '供应商期初预付补录_导入模板',
    templateUrl: '/init/ap/prepay-supplement/import-template',
    templateHeaders: ['供应商编码', '供应商名称', '期初预付金额', '备注'],
    fieldMap: {
      '供应商编码': 'supplierCode', '供应商名称': 'supplierName',
      '期初预付金额': 'prepayAmount', '备注': 'remark',
    },
    requiredKey: 'supplierCode',
    endpoint: '/init/ap/prepay-supplement/import',
    extra: () => ({}),
  },
}
